  ...
  sizes: [
    {
      ...
      label: "Extra Small",
      tokenOverrides: {
        height: createSystemRef("density.controlHeightSm"),
        paddingX: createSystemRef("spacing.2"),
        fontSize: createSystemRef("typography.fontSize.xs"),
        fontWeight: createSystemRef("typography.fontWeight.medium"),
        lineHeight: createSystemRef("typography.lineHeight.tight"),
        iconSize: createSystemRef("density.iconSizeSm"),
      },
    },
    {
      value: "sm",
    ...
    },
    {
      ...
      label: "Default",
      tokenOverrides: {
        height: createSystemRef("density.controlHeight"),
        paddingX: createSystemRef("spacing.4"),
        fontSize: createSystemRef("typography.fontSize.base"),
        fontWeight: createSystemRef("typography.fontWeight.medium"),
        lineHeight: createSystemRef("typography.lineHeight.normal"),
        iconSize: createSystemRef("density.iconSize"),
      },
    },
    {
      value: "lg",
      label: "Large",
      tokenOverrides: {
        height: createSystemRef("density.controlHeightLg"),
        paddingX: createSystemRef("spacing.6"),
        fontSize: createSystemRef("typography.fontSize.md"),
        fontWeight: createSystemRef("typography.fontWeight.medium"),
        lineHeight: createSystemRef("typography.lineHeight.normal"),
        iconSize: createSystemRef("density.iconSizeLg"),
      },
    },
    {
      value: "icon",
      ...
      tokenOverrides: {
        height: createSystemRef("density.controlHeight"),
        width: createSystemRef("density.controlHeight"),
        paddingX: createSystemRef("spacing.0"),
        iconSize: createSystemRef("density.iconSize"),
        hideLabel: createLiteralRef("true"),
      },
    },
    {
      value: "icon-xs",
    ...
    },
    {
      ...
      tokenOverrides: {
        height: createSystemRef("density.controlHeightSm"),
        width: createSystemRef("density.controlHeightSm"),
        paddingX: createSystemRef("spacing.0"),
        iconSize: createSystemRef("density.iconSizeSm"),
        hideLabel: createLiteralRef("true"),
      },
    },
    {
      ...
      tokenOverrides: {
        height: createSystemRef("density.controlHeightLg"),
        width: createSystemRef("density.controlHeightLg"),
        paddingX: createSystemRef("spacing.0"),
        iconSize: createSystemRef("density.iconSizeLg"),
        hideLabel: createLiteralRef("true"),
      },
